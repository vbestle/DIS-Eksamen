...
public final class Encryption {
  ...
  public static String encryptDecryptXOR(String rawString) {
    ...
    if (Config.getEncryption()) {
      ...
      String encryprionKey = Config.getEncryptionKey();

      char[] key = encryprionKey.toCharArray();

      // Stringbuilder enables you to play around with strings and make useful stuff
      StringBuilder thisIsEncrypted = new StringBuilder();

      // TODO: This is where the magic of XOR is happening. Are you able to explain what is going on? (FIX beskrevet rapport)
